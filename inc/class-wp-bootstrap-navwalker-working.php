...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
        ...
        public function start_lvl( &$output, $depth = 0, $args = array() ) {
            ...
            $output .= $depth === 0 ? "\n$indent<ul class=\"dropdown-menu\" >\n" : "\n$indent<ul role=\"menu\" class=\"dropdown-menu list-unstyled\" >\n";
        }
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            $value = '';
            $class_names = $value;
            $classes = empty( $item->classes ) ? array() : (array)get_post_meta( $item->ID, '_menu_item_classes', true );
            ...
            elseif($args->has_children && $depth > 0) { 
            	$class_names .= 'nav-item dropdown dropdown-col';
            }
            else { 
            ...
            if ( in_array( 'mega-menu', $classes, true ) ) {
                $class_names = 'nav-item mega-menu';
            }
            ...
            elseif ( $args->has_children && $depth === 1) {
                ...
                $atts['href']   = ! empty( $item->url ) ? $item->url : '';
                $atts['class']  = 'dropdown-item dropdown-link gggggggggg';
            }
            ...
            $item_output .= '<a' . $id . $attributes . ' itemprop="url">';
