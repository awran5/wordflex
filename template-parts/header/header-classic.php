...
<!-- Strat top Header -->
<div class="top-header top-header-classic" itemscope itemtype="http://schema.org/Organization">
    <div class="container">
        <div class="row">
        	<div class="col-12 col-md-4 my-auto">
            	...
            	<?php if (!empty($logo['url'])) : ?>
            	    <!-- Start Navbar brand -->
            	    <a class="navbar-brand text-center text-md-left" href="<?php echo esc_url(home_url('/')); ?>" itemprop="url" title="<?php echo esc_attr(get_bloginfo('name')); ?>" rel="home">
            ...
            <div class="col-12 col-md-8">
            	<?php if( _wf_get_option('opt-header-quick-contacts') ) _wf_header_contacts('text-md-right'); ?>
            	<?php if( _wf_get_option('opt-header-quick-socials') ) _wf_header_socials('text-md-right'); ?>
        	</div>	
        </div>
    </div>
</div>
...
<header class="site-header<?php echo $nav_style ?> bg-dark header-classic" role="banner" itemtype="http://schema.org/WPHeader">
    <div class="container">
        <!-- Start navbar -->
