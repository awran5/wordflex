...
<!-- Strat Header -->
<?php $nav_style = _wf_get_option('opt-sticky-nav') ? ' fixed-top' : ''; ?>
<header class="site-header header-transparent<?php echo $nav_style ?>" role="banner" itemtype="http://schema.org/WPHeader">
    <div class="container">
        <?php if ( _wf_get_option('opt-top-header') ) : ?>
            <!-- Strat top Header -->
            <div class="top-header top-header-transparent" itemscope itemtype="http://schema.org/Organization">
        ...
        ?>
        <!-- Start Sticky navbar -->
        <nav class="navbar navbar-dark navbar-expand-md megamenu">
